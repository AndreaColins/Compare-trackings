function ICAairpole2
%%%%this version of ICA analyse data in exploratory/touch periods, i.e,
...
[ic, A, W] = fastica(azel', 'numOfIC',6,'maxNumIterations',1000,'g','tanh','firstEig',1,'lastEig',6,'approach','symm');
sizeic=size(ic)
sizeA=size(A)
sizeW=size(W)
