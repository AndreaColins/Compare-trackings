function comparingPCAvar
%%%%separar loss vectores en pedazos de 100 ms y 1 hz(?)

%%%%%%get different conditions 
pole=char('air','smooth pole','closed coil','black sandpaper','open coil');
color={'g','r','c','k','p'};
npole=size(pole,1);
...
%%%%%%%%%%%%%%%%%%azimuth,elevation
 [COEFF, SCORE, LATENT, TSQUARED, EXPLAINED]=pca([tazimuth',televation'],'Algorithm','eig');
...
[COEFF, SCORE]=pca([tkhorizontal',tkcoronal']);
figure
%%%graficar en los nuevos vectores 
%scatter3(SCORE(1:34*nfiles(1),1),SCORE(1:34*nfiles(1),2),SCORE(1:34*nfiles(1),3),'b')
scatter(SCORE(1:34*nfiles(1),1),SCORE(1:34*nfiles(1),2),'b')
...
hold off
%%%%%%%%%%%%%%%%%%
[COEFF, SCORE]=pca([tkhorizontal',tazimuth']);
figure
%%%graficar en los nuevos vectores 
%scatter3(SCORE(1:34*nfiles(1),1),SCORE(1:34*nfiles(1),2),SCORE(1:34*nfiles(1),3),'b')
scatter(SCORE(1:34*nfiles(1),1),SCORE(1:34*nfiles(1),2),'b')
...
hold off
%%%%%%%%%%%%%%%%%%
[COEFF, SCORE]=pca([tkcoronal',televation']);
figure
%%%graficar en los nuevos vectores 
%scatter3(SCORE(1:34*nfiles(1),1),SCORE(1:34*nfiles(1),2),SCORE(1:34*nfiles(1),3),'b')
scatter(SCORE(1:34*nfiles(1),1),SCORE(1:34*nfiles(1),2),'b')
...
%%%%%%%%%%%%%%%%%%
[COEFF, SCORE]=pca([tkhorizontal',tazimuth',tkcoronal',televation']);
figure
%%%graficar en los nuevos vectores 
%scatter3(SCORE(1:34*nfiles(1),1),SCORE(1:34*nfiles(1),2),SCORE(1:34*nfiles(1),3),'b')
scatter(SCORE(1:34*nfiles(1),1),SCORE(1:34*nfiles(1),2),'b')
