...
for i=1:nfiles
%%%%%%%%%%%%%%%%%%%%azimuth fit    
ydata=log(power.azimuth(10:end,i));
ydata1=ydata(1:67);
ydata2=ydata(68:end);
...
%%%%%%%%%%%%%%%%%%%%elevation fit   
ydata=log(power.elevation(10:end,i));
ydata1=ydata(1:67);
ydata2=ydata(68:end);
...
%%%%%%%%%%%%%%%%%%%%kappa coronal
ydata=log(power.kcoronal(10:end,i));
ydata1=ydata(1:67);
ydata2=ydata(68:end);
...
%%%%%%%%%%%%%%%%%%%%kappa horizontal
ydata=log(power.khorizontal(10:end,i));
ydata1=ydata(1:67);
ydata2=ydata(68:end);
