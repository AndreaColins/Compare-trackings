...
for i=2:npole
hold on
scatter3(SCORE(totalfiles+1:(totalfiles+nresult(i)),4),SCORE(totalfiles+1:(totalfiles+nresult(i)),5),SCORE(totalfiles+1:(totalfiles+nresult(i)),6),[],'MarkerEdgeColor',colors(2,:))
%means(i)=mean(mean(azel(totalfiles+1:(totalfiles+nresult(i)),1:100)));
title('[Azimuth,Elevation]')
...
for i=2:npole
hold on
scatter(SCORE2(totalfiles+1:(totalfiles+nresult(i)),1),SCORE2(totalfiles+1:(totalfiles+nresult(i)),2),[],'MarkerEdgeColor',colors(2,:))
%means(i)=mean(mean(azel(totalfiles+1:(totalfiles+nresult(i)),1:100)));
title('[Azimuth,Elevation]')
xlabel('First component')
ylabel('Second component')
...
% poleclass(totalfiles+1:size(azel,2))={'pole'};
